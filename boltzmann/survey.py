...
def main(output="out.txt", *files):
    """Stacks multiple (x,y) datasets into one.
    Interpolates and averages datapoints in x ranges which several datasets share.
    Assumption: x data are sorted ascending. All x point inside common ranges are preserved."""
